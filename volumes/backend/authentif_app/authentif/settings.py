...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'authentif', 'authentif:9000']
# ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'authentif', 'authentif:9001']
...
CSRF_TRUSTED_ORIGINS = [ 'http://gateway:9000',]
