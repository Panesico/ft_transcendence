"""
Django settings for authentif project.
...
MIDDLEWARE = [
    ...
    'authentif.authmiddleware.JWTAuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'authentif.middleware.LogRequestMiddleware', 
]

ROOT_URLCONF = 'authentif.urls'
...
WSGI_APPLICATION = 'authentif.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/usr/src/app/logs/django-authentif.log',
            'formatter': 'standard',
        },
        'console': {
            'level': 'INFO',
        ...
        'uvicorn_file': {  # Separate file handler for Uvicorn logs
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/usr/src/app/logs/uvicorn-authentif.log',
            'formatter': 'uvicorn',
        },
    },
    'loggers': {
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'authentif', 'jorge-fernandez-moreno', 'www.jorge-fernandez-moreno.software']
