...
MIDDLEWARE = [
    ...
    'profileapi.authmiddleware.JWTAuthenticationMiddleware',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/usr/src/app/logs/django-profileapi.log',
            'formatter': 'standard',
        },
        'console': {
            'level': 'INFO',
        ...
        'uvicorn_file': {  # Separate file handler for Uvicorn logs
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/usr/src/app/logs/uvicorn-profileapi.log',
            'formatter': 'uvicorn',
        },
    },
    'loggers': {
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'profileapi', 'www.jorge-fernandez-moreno.software', 'jorge-fernandez-moreno']
